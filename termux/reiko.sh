...
echo ""
echo "[]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[]"
echo " • Author: Kenneth Panio"
echo " • Github: reiko_dev"
echo " • Tiktok: atomicslashtv"
echo " • Telegram: https://t.me/hackersdecipher"
echo " • Youtube: atomicslashtv"
echo " • Version: 1.7"
echo "[]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[]"
echo " * Features:"
echo "   • Enhanced Gaming Module"
echo "   • Enhanced GFX"
echo "   • Game Drivers"
echo "   • Enhanced NetSpeed Low Latency Gaming"
echo "   • Debloater"
echo "   • Thermal Throttle Off CPU and GPU"
echo "   • Background Apps Killer"
echo "   • Clear Cache and Kill-All Apps (Works After Flash)"
echo "   • 120hz Refresh Rate (Not All Phones Support)"
echo "[]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[]"
echo "Follow our social platforms for more future updates!"
expiration_date="2024-5-1"
...
resolution() {
  ...
  if [ "$width" -ge 144 ] && [ "$height" -ge 328 ] && [ "$width" -le 1080 ] && [ "$height" -le 2460 ]; then
  wm size "$screen_size" 
  else
  echo ""
  echo "Invalid screen size."
  echo "Please provide a size"
  echo "144x328 - 1080x2460."
  echo "<WidthxHeight>"
  echo ""
  exit 1
  fi
...
"javafx.animation.framerate 120"
"gr.swapinterval 0"
"angle.backend 2"
"ioprio 8"
"gpuprio 8"
"cpuprio 8"
"renderengine.backend skiaglthreaded"
...
"renderengine.backend skiaglthreaded"
"angle.overlay FPS:skiagl*PipelineCache*"
...
set_tweaks() {
  ...
  for package in $packages; do
    if [ "$package" != "me.piebridge.brevent" ]; then
        ...
        cmd device_config put game_overlay ${package} mode=2,downscaleFactor=0.5:mode=3,downscaleFactor=0.5 > /dev/null 2>&1
        opt_in_apps+="${package},"
    fi
  done
...
cmd device_config put privacy camera_mic_icons_enabled false default >/dev/null 2>&1
  ...
  pm grant com.draco.mfstrim android.permission.WRITE_SECURE_SETTINGS > /dev/null 2>&1
